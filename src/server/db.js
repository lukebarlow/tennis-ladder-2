...
const db = mongoist(dbUrl, { useNewUrlParser: true })
...
async function lastPlayed (playerId, callback) {
...
async function getRecentMatches () {
  console.log('trying to get recent matches')
  return db.match.findAsCursor().sort({ date: -1 }).limit(50).toArray()
}
